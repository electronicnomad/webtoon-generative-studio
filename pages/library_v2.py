...
def on_load(e: me.LoadEvent):
    ...
    if media_id and not pagestate.show_details_dialog:
        ...
        pagestate.datasets = get_all_datasets()
...
def on_dataset_filter_change(e: me.SelectSelectionChangeEvent):
    """Handles changes to the dataset filter."""
    pagestate = me.state(PageState)
    pagestate.selected_dataset = e.value
    yield from _load_media(pagestate, is_filter_change=True)
