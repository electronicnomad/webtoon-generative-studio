...
@me.page(
    path="/home",
    title="Gearframe Creative Studio - Home",
    security_policy=me.SecurityPolicy(
        dangerously_disable_trusted_types=True,
    ),
    stylesheets=[
        "https://fonts.googleapis.com/css2?family=Google+Symbols:opsz,wght,FILL,GRAD,ROND@20..48,100..700,0..1,-50..200,0..100",
...
def home_page_content(app_state: me.state):  # pylint: disable=unused-argument
    ...
    with me.box(
        ...
        header("Gearframe Creative Studio", "home")
