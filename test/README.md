...
This directory contains the automated tests for the Gearframe Webtoon Studio application.
...
이 디렉토리에는 Gearframe Webtoon Studio 애플리케이션에 대한 자동화된 테스트가 포함되어 있습니다.
