...
def generate_script(prompt: str) -> str:
    """Generates a webtoon/anime script using Gemini."""
    model_name = cfg.MODEL_ID # Use default or specific model
    ...
    with track_model_call(model_name=model_name, task="generate_script"):
